  ...
  <main>
    ...
    <div class="bg-white min-h-screen pt-16 pb-24">
      <div class="container mx-auto px-6 max-w-3xl">
        <p class="text-gray-500 mb-8 font-medium">Last updated: June 22, 2026</p>
        <p class="text-gray-600 leading-relaxed mb-6">
          Please read these terms and conditions carefully before using Our
          Service.
        </p>
        <h2 class="text-2xl md:text-3xl font-mirage text-gray-800 mt-12 mb-6">Interpretation and Definitions</h2>
        <h3 class="text-xl md:text-2xl font-mirage text-gray-800 mt-8 mb-4">Interpretation</h3>
        ...
        <h3 class="text-xl md:text-2xl font-mirage text-gray-800 mt-8 mb-4">Definitions</h3>
        <p class="text-gray-600 leading-relaxed mb-4">For the purposes of these Terms and Conditions:</p>
        <ul class="list-disc list-outside ml-6 text-gray-600 leading-relaxed space-y-3 mb-8">
          <li>
            <p class="text-gray-600 leading-relaxed mb-4">
          ...
          <li>
            <p class="text-gray-600 leading-relaxed mb-4"><strong>Country</strong> refers to: Maharashtra, India</p>
          </li>
          <li>
            <p class="text-gray-600 leading-relaxed mb-4">
              <strong>Company</strong> (referred to as either &quot;the
              Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot;
              in these Terms and Conditions) refers to Dr. Nihar Modi.
            </p>
          </li>
          <li>
            <p class="text-gray-600 leading-relaxed mb-4">
          ...
          <li>
            <p class="text-gray-600 leading-relaxed mb-4"><strong>Service</strong> refers to the Website.</p>
          </li>
          <li>
            <p class="text-gray-600 leading-relaxed mb-4">
              <strong>Terms and Conditions</strong> (also referred to as
              &quot;Terms&quot;) means these Terms and Conditions, including any
              documents expressly incorporated by reference, which govern Your
              access to and use of the Service and form the entire agreement
              between You and the Company regarding the Service. These Terms and
              Conditions have been created with the help of the
              <a
          ...
          <li>
            <p class="text-gray-600 leading-relaxed mb-4">
              ...
              services) provided by a third party that is displayed, included,
              made available, or linked to through the Service.
            </p>
          </li>
          <li>
            <p class="text-gray-600 leading-relaxed mb-4">
        ...
        <h2 class="text-2xl md:text-3xl font-mirage text-gray-800 mt-12 mb-6">Acknowledgment</h2>
        <p class="text-gray-600 leading-relaxed mb-4">
        ...
        <p class="text-gray-600 leading-relaxed mb-4">
          ...
          information. Please read Our Privacy Policy carefully before using Our
          Service.
        </p>
        <h2 class="text-2xl md:text-3xl font-mirage text-gray-800 mt-12 mb-6">Links to Other Websites</h2>
        <p class="text-gray-600 leading-relaxed mb-4">
        ...
        <h3 class="text-xl md:text-2xl font-mirage text-gray-800 mt-8 mb-4">Links from a Third-Party Social Media Service</h3>
        <p class="text-gray-600 leading-relaxed mb-4">
          ...
          Company, and the Company does not endorse or assume responsibility for
          any Third-Party Social Media Service.
        </p>
        <p class="text-gray-600 leading-relaxed mb-4">
          You acknowledge and agree that the Company shall not be responsible or
          liable, directly or indirectly, for any damage or loss caused or
          alleged to be caused by or in connection with Your access to or use of
          any Third-Party Social Media Service, including any content, goods, or
          services made available through them. Your use of any Third-Party
          Social Media Service is governed by that Third-Party Social Media
          Service's terms and privacy policies.
        </p>
        <h2 class="text-2xl md:text-3xl font-mirage text-gray-800 mt-12 mb-6">Termination</h2>
        <p class="text-gray-600 leading-relaxed mb-4">
        ...
        <h2 class="text-2xl md:text-3xl font-mirage text-gray-800 mt-12 mb-6">Limitation of Liability</h2>
        <p class="text-gray-600 leading-relaxed mb-4">
        ...
        <h2 class="text-2xl md:text-3xl font-mirage text-gray-800 mt-12 mb-6">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
        <p class="text-gray-600 leading-relaxed mb-4">
        ...
        <h2 class="text-2xl md:text-3xl font-mirage text-gray-800 mt-12 mb-6">Governing Law</h2>
        <p class="text-gray-600 leading-relaxed mb-4">
        ...
        <h2 class="text-2xl md:text-3xl font-mirage text-gray-800 mt-12 mb-6">Disputes Resolution</h2>
        <p class="text-gray-600 leading-relaxed mb-4">
          If You have any concern or dispute about the Service, You agree to
          first try to resolve the dispute informally by contacting the Company.
        </p>
        <h2 class="text-2xl md:text-3xl font-mirage text-gray-800 mt-12 mb-6">For European Union (EU) Users</h2>
        <p class="text-gray-600 leading-relaxed mb-4">
          If You are a European Union consumer, you will benefit from any
          mandatory provisions of the law of the country in which You are
          resident.
        </p>
        <h2 class="text-2xl md:text-3xl font-mirage text-gray-800 mt-12 mb-6">United States Legal Compliance</h2>
        <p class="text-gray-600 leading-relaxed mb-4">
        ...
        <h2 class="text-2xl md:text-3xl font-mirage text-gray-800 mt-12 mb-6">Severability and Waiver</h2>
        <h3 class="text-xl md:text-2xl font-mirage text-gray-800 mt-8 mb-4">Severability</h3>
        <p class="text-gray-600 leading-relaxed mb-4">
        ...
        <h3 class="text-xl md:text-2xl font-mirage text-gray-800 mt-8 mb-4">Waiver</h3>
        <p class="text-gray-600 leading-relaxed mb-4">
        ...
        <h2 class="text-2xl md:text-3xl font-mirage text-gray-800 mt-12 mb-6">Translation Interpretation</h2>
        <p class="text-gray-600 leading-relaxed mb-4">
          These Terms and Conditions may have been translated if We have made
          them available to You on our Service. You agree that the original
          English text shall prevail in the case of a dispute.
        </p>
        <h2 class="text-2xl md:text-3xl font-mirage text-gray-800 mt-12 mb-6">Changes to These Terms and Conditions</h2>
        <p class="text-gray-600 leading-relaxed mb-4">
        ...
        <h2 class="text-2xl md:text-3xl font-mirage text-gray-800 mt-12 mb-6">Contact Us</h2>
        <p class="text-gray-600 leading-relaxed mb-4">
        ...
        <ul class="list-disc list-outside ml-6 text-gray-600 leading-relaxed space-y-3 mb-8">
          <li>
            <p class="text-gray-600 leading-relaxed mb-4">By email: modi.nihar95@gmail.com</p>
          </li>
          <li>
            <p class="text-gray-600 leading-relaxed mb-4">By phone: +91 98330 66702</p>
          </li>
        </ul>
      </div>
    </div>
