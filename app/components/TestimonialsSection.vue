  ...
  <section class="py-24 bg-white overflow-hidden">
    <div class="container mx-auto px-4 lg:px-8 text-center">
      ...
      >
        ...
        <div class="w-full lg:w-1/3 grid place-items-center flex-shrink-0 z-10 order-1 lg:order-2">
          ...
          >
            <Transition :name="transitionName">
              ...
              >
                ...
                <div class="flex justify-center lg:justify-end text-blue-400 mb-2 gap-1">
                  <svg
        ...
        <div class="flex flex-col w-full lg:w-1/3 order-3">
          ...
          <!-- Review Text -->
          <div class="text-center lg:text-left relative min-h-[100px] lg:min-h-[120px] grid place-items-center lg:place-items-start px-4">
            <!-- Quote Icon -->
            <div
        ...
        <div class="flex lg:hidden order-4 w-full overflow-x-auto gap-3 px-4 py-2 mt-4 justify-start no-scrollbar">
          <img
            v-for="test in testimonials"
            :key="'mob-' + test.originalIndex"
            :src="test.img"
            @click="setActive(test.originalIndex, test.originalIndex > activeIndex ? 'slide-next' : 'slide-prev')"
            class="w-20 h-28 object-cover rounded flex-shrink-0 transition-all duration-300 cursor-pointer"
            :class="test.originalIndex === activeIndex ? 'grayscale-0 ring-2 ring-primary scale-[1.02] shadow-md' : 'grayscale opacity-70 hover:opacity-100'"
            alt="Patient Thumbnail"
          />
        </div>
      </div>
